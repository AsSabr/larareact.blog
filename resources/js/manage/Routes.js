    ...
    render() {
        return (
            <Switch>
                ...
                <AuthenticatedRoute exact path='/tags/add' component={AddTags}/>
                <AuthenticatedRoute exact path='/tags/edit/:id' component={EditTags}/>
                <AuthenticatedRoute exact path='/users' component={ListUsers}/>
                <AuthenticatedRoute exact path='/users/add' component={AddUsers}/>
                <AuthenticatedRoute exact path='/users/edit/:id' component={EditUsers}/>
            </Switch>
        );
    }
}
